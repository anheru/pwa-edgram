  ...
  const cameraScripts = setInterval(() => {
    if (d.readyState === 'complete') {
      ...
      function cameraInit() {
        ...
        if (!n.getMedia) {
          ...
          n.getMedia(
            ...
            err=> output.innerHTML = erroMsg('Hubo un error al acceder a la cámara de tu dispositivo')
          )
        }
      }
      ...
      function cameraReset () {
        ...
        // Limpiar el snapshot de la imagen dinámica
      ...
      takePhotoBtn.addEventListener('click', e => {
        ...
        // Habilitamos botones de eliminar, subir y descargar
